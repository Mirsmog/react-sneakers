function Card() {
  return (
    <li className="cart-item">
      <button className="favorite-btn added cart-btn">
        <svg
          width="15"
          height="14"
          viewBox="0 0 15 14"
      ...
      />
      <h3 className="cart-title">Мужские Кроссовки Nike Blazer Mid Suede</h3>
      <div className="cart-bottom">
        <div className="cart__left">
          <p className="cart-price-text">Цена:</p>
          <div className="cart-price">12 999 руб.</div>
        </div>
        <div className="cart__right">
          <button className="cart-add-btn added cart-btn"></button>
        </div>
      </div>
    </li>
  );
